...
import com.coder2195.notjavascript.world.features.LandmineGenerationFeature;
...
public class NotJavascriptModFeatures {
	...
	public static final RegistryObject<Feature<?>> LANDMINE_GENERATION = REGISTRY.register("landmine_generation", LandmineGenerationFeature::new);
}
