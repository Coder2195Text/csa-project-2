package com.coder2195.notjavascript.client.model;
...
public class ModelBlock<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("not_javascript", "model_block"), "main");
