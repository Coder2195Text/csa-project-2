...
package com.coder2195.notjavascript.world.inventory;
...
public class EnrichingGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EnrichingGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(NotJavascriptModMenus.ENRICHING_GUI.get(), id);
		...
		this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 43, 17) {
			...
			@Override
			public boolean mayPlace(ItemStack stack) {
				return NotJavascriptModItems.RAW_URANIUM.get() == stack.getItem();
			}
		}));
